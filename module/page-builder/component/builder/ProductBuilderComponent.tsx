...
import { Label } from "@/module/page-builder/component/Label"
import { TextInput } from "@/module/page-builder/component/TextInput"
import InputComponent from "@/module/shared/component/form/InputComponent"

export interface ProductBuilderComponentPropsInterface {
  productName: string
}

export default function ProductBuilderComponent(
  props: ProductBuilderComponentPropsInterface
) {
  const {
  ...
  return (
    <div className="md:flex md:items-center" ref={(ref) => connect(drag(ref))}>
      ...
      <div className="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
        <h3 className="text-gray-700 uppercase text-lg"> {props.productName} </h3>
  ...
  return (
    <>
      <InputComponent
        ...
        onChange={(e) => {
          setProp((props) => (props.productName = e.target.value), 1000)
        }}
      />
    </>
  )
...
export const ProductBuilderDefaultComponent = {
  productName: "Nike Air",
}

ProductBuilderComponent.craft = {
  displayName: "Product Builder",
  props: ProductBuilderDefaultComponent,
  rules: {
    canDrag: () => true,
  },
  related: {
