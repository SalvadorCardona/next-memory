...
export function TableComponent(props: TableComponentPropsInterface) {
  return (
    <div className="py-8">
      <div>
      ...
      <div className="my-2 flex sm:flex-row flex-col">
        ...
        {props.onCreate && (
          <div className="block relative h-full absolute inset-y-0 left-0 flex items-center pl-2">
            <ButtonComponent onClick={props.onCreate}>Create new</ButtonComponent>
          </div>
        )}
      </div>
      <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
        <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
          <table className="min-w-full leading-normal">{props.children}</table>
...
export function TableHeadItem(props: { children: ReactNode }) {
  return (
