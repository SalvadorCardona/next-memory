import PageBuilderViewComponent from "@/module/page-builder/view/PageBuilderViewComponent"
              ...
              <div className="flex flex-row -mx-3">
                ...
                <div className="px-3 text-right basis-1/3">
                  <div className="inline-block w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-blue-500 to-violet-500">
                    <i className="ni ni-money-coins text-lg relative top-3.5 text-white" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-row -mx-3">
                ...
                <div className="px-3 text-right basis-1/3">
                  <div className="inline-block w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-emerald-500 to-teal-400">
                    <i className="ni ni-paper-diploma text-lg relative top-3.5 text-white" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-row -mx-3">
                ...
                <div className="px-3 text-right basis-1/3">
                  <div className="inline-block w-12 h-12 text-center rounded-circle bg-gradient-to-tl from-orange-500 to-yellow-500">
                    <i className="ni ni-cart text-lg relative top-3.5 text-white" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="flex flex-wrap mt-6 -mx-3">
          ...
          <div className="border-black/12.5 dark:bg-slate-850 dark:shadow-dark-xl shadow-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
            <div className="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid p-6 pt-4 pb-0">
              ...
              <p className="mb-0 leading-normal dark:text-white dark:opacity-60 text-sm">
                <i className="fa fa-arrow-up text-emerald-500" aria-hidden="true" />
        ...
        <div className="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
          ...
          >
            ...
            <button
              btn-next=""
              className="absolute z-10 w-10 h-10 p-2 text-white border-none opacity-50 cursor-pointer text-lg hover:opacity-100 far fa-chevron-right active:scale-110 top-6 right-4"
              aria-hidden="true"
            />
            <button
              btn-prev=""
                  ...
                  <tr>
                    <td className="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                      <div className="flex items-center px-2 py-1">
                        <div>
                          <img
                            src="https://demos.creative-tim.com/argon-dashboard-tailwind/assets/img/icons/flags/US.png"
                            alt="Country flag"
                          />
                        </div>
                        <div className="ml-6">
                  ...
                  <tr>
                    <td className="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                      <div className="flex items-center px-2 py-1">
                        <div>
                          <img
                            src="https://demos.creative-tim.com/argon-dashboard-tailwind/assets/img/icons/flags/DE.png"
                            alt="Country flag"
                          />
                        </div>
                        <div className="ml-6">
                  ...
                  <tr>
                    <td className="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                      <div className="flex items-center px-2 py-1">
                        <div>
                          <img
                            src="https://demos.creative-tim.com/argon-dashboard-tailwind/assets/img/icons/flags/GB.png"
                            alt="Country flag"
                          />
                        </div>
                        <div className="ml-6">
                  ...
                  <tr>
                    <td className="p-2 align-middle bg-transparent border-0 w-3/10 whitespace-nowrap">
                      <div className="flex items-center px-2 py-1">
                        <div>
                          <img
                            src="https://demos.creative-tim.com/argon-dashboard-tailwind/assets/img/icons/flags/BR.png"
                            alt="Country flag"
                          />
                        </div>
                        <div className="ml-6">
          ...
          <div className="flex flex-wrap items-center -mx-3 lg:justify-between">
            <div className="w-full max-w-full px-3 mt-0 mb-6 shrink-0 lg:mb-0 lg:w-1/2 lg:flex-none">
              <div className="leading-normal text-center text-sm text-slate-500 lg:text-left">
                © 2023, made with <i className="fa fa-heart" aria-hidden="true" /> by
                <a
